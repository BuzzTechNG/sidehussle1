...
const card = (props) => {
  return props.isGrid ? (
    <NavLink to="/dashboard/avaliablejobs/56d6dsh" class="col-sm-12 col-md-6 col-lg-6 col-xl-4 my-4">
    ...
    <NavLink to="/dashboard/avaliablejobs/56d6dsh" className="xcard row p-3 pl-4 mx-auto" style={{ width: "96%" }}>
      <div className="pr-3">
      ...
      <div className="col">
        ...
        <div className="row subtitle3 px-4">
          <li className="row align-items-center p-2 col-md-6 col-sm-12 p-0">
           <span> <i className="fa fa-hourglass pr-2 "></i>
            Open 1minute ago -- 2 Interested Users</span>
          </li>
          <li className="row align-items-center p-2 col-md-6 col-sm-12">
          <span>  <i className="fa fa-layer-group  pr-2"></i>
            {props.topic}</span>
          </li>
        </div>
      </div>
